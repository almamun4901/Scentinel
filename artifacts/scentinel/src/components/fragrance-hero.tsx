...
export function FragranceHero({ fragrance }: FragranceHeroProps) {
  return (
    ...
    >
      {/* Header */}
      <div className="mb-4">
        <p className="text-xs font-mono tracking-widest uppercase mb-1" style={{ color: "hsl(40 10% 45%)" }}>
          {fragrance.house}
        </p>
        <h1
      ...
      {/* Longevity & Sillage */}
      <div className="grid grid-cols-2 gap-4 mt-4 pt-4 border-t" style={{ borderColor: "hsl(34 10% 14%)" }}>
        <div>
